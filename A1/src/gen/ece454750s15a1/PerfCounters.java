...
public class PerfCounters implements org.apache.thrift.TBase<PerfCounters, PerfCounters._Fields>, java.io.Serializable, Cloneable, Comparable<PerfCounters> {
  ...
  private static final org.apache.thrift.protocol.TField NUM_SECOND_UP_FIELD_DESC = new org.apache.thrift.protocol.TField("numSecondUp", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // NUM_SECOND_UP
          return NUM_SECOND_UP;
  ...
  private static final int __NUMSECONDUP_ISSET_ID = 0;
  ...
  static {
    ...
    tmpMap.put(_Fields.NUM_SECOND_UP, new org.apache.thrift.meta_data.FieldMetaData("numSecondUp", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  {
    this();
    this.numSecondUp = numSecondUp;
    setNumSecondUpIsSet(true);
  ...
  public PerfCounters(PerfCounters other) {
    ...
    this.numSecondUp = other.numSecondUp;
  ...
  public int getNumSecondUp() {
    return this.numSecondUp;
  }

  public PerfCounters setNumSecondUp(int numSecondUp) {
    this.numSecondUp = numSecondUp;
    setNumSecondUpIsSet(true);
    return this;
  }

  public void unsetNumSecondUp() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUMSECONDUP_ISSET_ID);
  }

  /** Returns true if field numSecondUp is set (has been assigned a value) and false otherwise */
  public boolean isSetNumSecondUp() {
    return EncodingUtils.testBit(__isset_bitfield, __NUMSECONDUP_ISSET_ID);
  }

  public void setNumSecondUpIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUMSECONDUP_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case NUM_SECOND_UP:
      return Integer.valueOf(getNumSecondUp());
  ...
  public boolean equals(PerfCounters that) {
    ...
    boolean this_present_numSecondUp = true;
    boolean that_present_numSecondUp = true;
    if (this_present_numSecondUp || that_present_numSecondUp) {
      if (!(this_present_numSecondUp && that_present_numSecondUp))
        return false;
      if (this.numSecondUp != that.numSecondUp)
        return false;
    }
  ...
  public int compareTo(PerfCounters other) {
    ...
    lastComparison = Boolean.valueOf(isSetNumSecondUp()).compareTo(other.isSetNumSecondUp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumSecondUp()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numSecondUp, other.numSecondUp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    sb.append("numSecondUp:");
    sb.append(this.numSecondUp);
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class PerfCountersStandardScheme extends StandardScheme<PerfCounters> {
        ...
        switch (schemeField.id) {
          case 1: // NUM_SECOND_UP
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.numSecondUp = iprot.readI32();
              struct.setNumSecondUpIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PerfCounters struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(NUM_SECOND_UP_FIELD_DESC);
      oprot.writeI32(struct.numSecondUp);
      oprot.writeFieldEnd();
